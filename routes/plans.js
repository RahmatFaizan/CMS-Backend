...
const validate = validations => {
    return async (req, res, next) => {
        ...
        res.status(400).json({error: "Incorrect data structure or missing data", errors: errors.array()}); /* errors.array() */
    };
};
...
router.post('/api/v1/healthcare/plans', validate([
    ...
    try {
        ...
        let {zipcode, uses_tobacco, income, age, gender, issuers = []} = req.body;
